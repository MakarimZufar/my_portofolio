...
import TechStackCarousel from "@/components/TechStackLayeredCarousel";
import TechBadge from "@/components/TechBadge";

// Ucapan "Halo" dalam berbagai bahasa
...
// Peran profesional untuk efek pengetikan
const roles = [
...
// Pesan kontak yang berganti-ganti
...
export default function HomePage() {
    // State untuk animasi ucapan "Halo"
    const [helloText, setHelloText] = useState("");
    const [helloIndex, setHelloIndex] = useState(0);
    const [isDeletingHello, setIsDeletingHello] = useState(false);

    // State untuk animasi pengetikan peran
    const [typedRole, setTypedRole] = useState("");
    const [isDeleting, setIsDeleting] = useState(false);
    const [roleIndex, setRoleIndex] = useState(0);

    // State untuk pesan kontak yang berganti-ganti
    const [messageIndex, setMessageIndex] = useState(0);

    // State untuk efek flip card
    const [cardState, setCardState] = useState("front");
    const cardRef = useRef(null);

    // Effect untuk animasi pengetikan teks "Halo"
    useEffect(() => {
    ...
    // Effect untuk animasi pengetikan peran
    useEffect(() => {
    ...
    // Effect untuk mengganti pesan kontak
    useEffect(() => {
    ...
    // Fungsi-fungsi untuk mengatur efek flip card
    ...
    return (
        <main className="relative pt-48 flex flex-col items-center px-6 sm:px-20 py-16 gap-24 text-white overflow-hidden">
            ...
            {/* Tech Stack Carousel - Komponen yang diimpor */}
            ...
            <section className="w-full max-w-6xl">
                ...
                {/* Horizontal scroll container untuk mobile, grid untuk desktop */}
                <div className="flex overflow-x-auto pb-8 md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 scrollbar-hide snap-x snap-mandatory">
                    {/* Project Card 1 */}
                    <motion.div
                        className="min-w-[280px] w-80 md:w-auto flex-shrink-0 snap-center bg-white/5 backdrop-blur-md rounded-xl overflow-hidden shadow-lg border border-white/10 group"
                    ...
                    >
                        ...
                        <div className="p-5">
                            ...
                            <p className="text-gray-400 text-sm mb-4 line-clamp-2">
                                Portofolio pertama ku untuk menampilkan
                                perjalanan, kemampuan, dan proyek-proyek yang
                                telah saya buat. Dibangun dengan Next.js dan
                                Tailwind CSS.
                            </p>
                            <div className="flex flex-wrap gap-2 mb-4">
                                {/* Menggunakan komponen TechBadge */}
                    ...
                    >
                        <div className="relative h-48 overflow-hidden">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-0 group-hover:opacity-70 transition-opacity duration-300 flex items-center justify-center">
                                <div className="transform translate-y-8 group-hover:translate-y-0 transition-transform duration-300">
                                    <Link
                                        href="/projects"
                                        className="px-4 py-2 bg-purple-600 text-white rounded-full text-sm inline-block"
                                    >
                                        View Details
                                    </Link>
                                </div>
                        ...
                        <div className="p-5">
                            ...
                            <p className="text-gray-400 text-sm mb-4 line-clamp-2">
                                RosoJogja adalah aplikasi kuliner yang dirancang
                                khusus untuk membantu Anda menemukan dan memesan
                                makanan atau minuman dari berbagai restoran dan
                    ...
                    >
                        <div className="relative h-48 overflow-hidden">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-0 group-hover:opacity-70 transition-opacity duration-300 flex items-center justify-center">
                                <div className="transform translate-y-8 group-hover:translate-y-0 transition-transform duration-300">
                                    <Link
                                        href="/projects"
                                        className="px-4 py-2 bg-green-500 text-white rounded-full text-sm inline-block"
                                    >
                                        View Details
                                    </Link>
                                </div>
                        ...
                        <div className="p-5">
                            ...
                            <p className="text-gray-400 text-sm mb-4 line-clamp-2">
                                Aplikasi navigasi dan transportasi untuk
                                membantu pengguna menemukan rute terbaik dan
                                berbagi perjalanan dengan teman.
                            </p>
                            <div className="flex flex-wrap gap-2 mb-4">
                                {/* Menggunakan komponen TechBadge */}
                                <TechBadge name="React" />
